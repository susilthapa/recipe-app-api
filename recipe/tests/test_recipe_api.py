...
class PrivateRecipeApiTests(TestCase):
  ...
  def test_create_basic_recipe_success(self):
    ...
    for key in payload.keys():
        ...
        #if recipe.key is used it returns value of key named key from recipe /
        #  and same as recipe.key using variable
...
class RecipeImageUploadTest(TestCase):
  ...
  def test_upload_image_bad_requiest(self):
